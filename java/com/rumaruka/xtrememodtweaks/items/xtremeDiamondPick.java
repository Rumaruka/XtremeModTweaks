...
public class xtremeDiamondPick extends ItemPickaxe {

	public xtremeDiamondPick(ToolMaterial p_i45347_1_) {
		super(xtrememodtweaks.xtremetoolfordiamond);
		setUnlocalizedName("XtremeDiamondPick");
		setTextureName(Reference.MODID+":"+"x_w_d");
	...
	public void addInformation(ItemStack is, EntityPlayer ep, List l, boolean b) {
		...
		l.add(EnumChatFormatting.GRAY+"IMBA EFFICIENCY");
	}
	@Override
