...
public class xtremeStonePick extends ItemPickaxe {
	public xtremeStonePick(ToolMaterial p1) {
		super(xtrememodtweaks.xtremetoolforstone);
		setUnlocalizedName("XtremeStonePick");
		setTextureName(Reference.MODID+":"+"x_w_s");
	...
	public void addInformation(ItemStack is, EntityPlayer ep, List l, boolean b) {
		...
		l.add(EnumChatFormatting.GRAY+"Efficiency This Pickaxe == Default Iron Pickaxe");
	}
	@Override
