...
public class xtremeWoodPick extends ItemPickaxe {

	public xtremeWoodPick(ToolMaterial p1) {
		super(xtrememodtweaks.xtremetoolforwooden);
		setUnlocalizedName("XtremeWoodPick");
		setTextureName(Reference.MODID+":"+"x_w_p");
...
public void addInformation(ItemStack is, EntityPlayer ep, List l, boolean b) {
	...
	l.add(EnumChatFormatting.GRAY+"Efficiency This Pickaxe == Default Stone Pickaxe");
}
@Override
