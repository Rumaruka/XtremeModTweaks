...
public class xtremeGoldPick extends ItemPickaxe {
	public xtremeGoldPick(ToolMaterial p1) {
		super(xtrememodtweaks.xtremetoolforgold);
		setUnlocalizedName("XtremeGoldPick");
		setTextureName(Reference.MODID+":"+"x_w_g");
	...
	public void addInformation(ItemStack is, EntityPlayer ep, List l, boolean b) {
		...
		l.add(EnumChatFormatting.GRAY+"IMBA ENCHANTABILITY");
	}
	@Override
